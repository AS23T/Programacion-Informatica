...
namespace WebApplicationDBFirst.Controllers
{
    ...
    {
        private readonly MiWebEfdbContext _context;

        public ContactoesController(MiWebEfdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Fono")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Fono")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
